...
function laClaveSecreta(elMensaje) { //String es un array
    let clave = elMensaje.reverse  
        return elMensaje.join
} 

console.log(laClaveSecreta["a","l","o","H"]) //Invertir el orden de las letras
